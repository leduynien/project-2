                                ...
                                <div class="pd-rating">
                                    @for($i = 1; $i <= 5; $i++)
                                        ...
                                        <i class="fa fa-star-o"></i>
                                         @endif
                                    @endfor
                                    <span>({{ count($product->feedback) }})</span>
                                </div>
                                <div class="pd-desc">
                                    <p> {{ $product->content }}</p>
                    ...
                    <div class="product-tab">
                        <div class="tab-item">
                            <ul class="nav" role="tablist">
                                ...
                                <li>
                                    <a data-toggle="tab" href="#tab-3" role="tab">Customer Reviews ({{ count($product->feedback) }})</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="tab-3" role="tabpanel">
                                    <div class="customer-review-option">
                                        <h4>{{ count($product->feedback) }} Comments</h4>
                                        <div class="comment-option">
                                        @foreach($product->feedback as $feedback) 
                                            <div class="co-item">
                                                <div class="avatar-pic">
                                                    <img src="front/img/product-single/{{ $feedback->user->avatar ?? 'avatar-macdinh-1.png' }}" alt="">
                                                </div>
                                                <div class="avatar-text">
                                                    ...
                                                    <h5>{{$feedback->name}} <span>{{ date('M d, Y', strtotime($feedback->created_at)) }}</span></h5>
                                                    <div class="at-reply">{{ $feedback->messages }}</div>
                                                </div>
                                            </div>
                                        @endforeach 
                                        </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="personal-rating">
                                                            ...
                                                            <div class="rate">
                                                                ...
                                                                <label for="star5" title="text" class="fa fa-star">5 stars</label>
                                                                <input type="radio" id="star4" name="rating" value="4" />
                                                                <label for="star4" title="text" class="fa fa-star">4 stars</label>
                                                                <input type="radio" id="star3" name="rating" value="3" />
                                                                <label for="star3" title="text" class="fa fa-star">3 stars</label>
                                                                <input type="radio" id="star2" name="rating" value="2" />
                                                                <label for="star2" title="text" class="fa fa-star">2 stars</label>
                                                                <input type="radio" id="star1" name="rating" value="1" />
                                                                <label for="star1" title="text" class="fa fa-star">1 star</label>
                                                            </div>
                                                        </div>
